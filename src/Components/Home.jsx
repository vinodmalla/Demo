...
function Home() {
  ...
  const About = [
    ...
    },
    {
      ...
      icon: <PeopleAltIcon sx={{ fontSize: 260}} />,
    },
    {
      ...
      icon: <GroupWorkIcon sx={{ fontSize: 260}} />,
    },
    {
      ...
      icon: <StarRateIcon sx={{ fontSize: 260}} />,
    },
  ];
     ...
     <div className="relative bg-gray-100 w-full">
      ...
      <div className="relative w-full h-screen">
        ...
        <div className="absolute inset-0 flex items-center justify-center px-4 z-10">
          <h1 className="sm:w-3/5 text-white text-xl sm:text-6xl font-extrabold text-center pt-120 flex flex-wrap justify-center leading-relaxed">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-10 p-10 md:p-20 bg-gray-50">
       {About.map((about, index) => (
  <div
    key={index}
    className="group bg-white rounded-2xl shadow-lg p-6 transform transition-all duration-300 hover:scale-105 hover:bg-[#1976d2] hover:opacity-80 flex flex-col items-center text-center"
  >
    <div className="w-full">
      {/* ICON */}
      <div className="mb-4 text-[#1976d2] group-hover:text-white transition-colors duration-300 text-[100px] sm:text-[160px] md:text-[200px]">
        {about.icon}
      </div>

      {/* TITLE */}
      <h2 className="text-2xl font-semibold mb-2 text-gray-600 group-hover:text-black transition-colors duration-300">
        {about.title}
      </h2>

      {/* DESCRIPTION */}
      <p className="text-lg text-gray-600 group-hover:text-black transition-colors duration-300 overflow-hidden">
        {expandedIndex === index
          ? about.description
      ...
      {/* BUTTON */}
      <button
        className="mt-4 text-blue-600 group-hover:text-white hover:underline text-lg"
        onClick={() => {
